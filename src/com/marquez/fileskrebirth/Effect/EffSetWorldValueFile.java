...
public class EffSetWorldValueFile extends Effect{
	private Expression<String> key;
	private Expression<World> value;
	...
	public boolean init(final Expression<?>[] arg0, final int arg1, final Kleenean arg2, final SkriptParser.ParseResult arg3) {
		...
		this.value = (Expression<World>)arg0[1];
		this.file = (Expression<String>)arg0[2];
		return true;
	}

	public String toString(@Nullable final Event arg0, final boolean arg1) {
		return "set file world key value";
	}
	...
	protected void execute(final Event arg0) {
		...
		final String value = StringUtil.worldToString((World)this.value.getSingle(arg0));
		try {
